...
class ConnectPage(GridLayout):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)  ##Super keyboard being used to call the parent function in the method
        self.cols = 2
...
class ChatPage(GridLayout):
    ...
    def incoming_message(self, username, message):
        self.history.update_chat_history("[color=20dd20]{username}[/color]> {message}")       
